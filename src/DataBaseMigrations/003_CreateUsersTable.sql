...
CREATE TABLE [dbo].[Users](
  ...
  [PaisId] [int] NOT NULL,
  FOREIGN KEY (PaisId) REFERENCES Countries(Id),
  CONSTRAINT [PK_Users] PRIMARY KEY CLUSTERED ([Id] ASC)) ON [PRIMARY]
GO

INSERT INTO [dbo].[Users]
    ([Username],[Password],[Name],[Email], [PaisId])
  VALUES
    ('system','0573915C3BDF76AB4F0A66CE5EA90E15787321ED','System User','miguelpintodacosta@gmail.com', 1);
    -- password: system_123
GO
